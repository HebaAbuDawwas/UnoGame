package com.atypon.play.cardgameverse.gamegallery.uno.constants;

public class Constants {
    public static final String YOUR_TURN = " Its your turn";
    public static final String NUMBER_OF_PLAYERS_OUT_OF_POUND = "Uno Game Can not handle less than 2 or more than 10 players because it have limited cards number";
    ...
    public static final String WINNER_MESSAGE = " Congratulations you are the winner.";
}
